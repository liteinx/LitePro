...
# APK Management Script for Emerald
...
APKS_DIR="$SCRIPT_DIR"
BASE_URL="https://liteinx.github.io/LitePro/Emerald"
...
if [ -f "$DEST_PATH" ]; then
    echo -e "${YELLOW}⚠ Warning: APK file already exists in Emerald directory${NC}"
...
# Copy APK to Emerald directory
echo -e "${BLUE}📦 Copying APK to Emerald directory...${NC}"
