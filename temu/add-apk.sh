...
# APK Management Script for Temu
...
APKS_DIR="$SCRIPT_DIR"
BASE_URL="https://liteinx.github.io/LitePro/temu"
...
if [ -f "$DEST_PATH" ]; then
    echo -e "${YELLOW}⚠ Warning: APK file already exists in Temu directory${NC}"
...
# Copy APK to Temu directory
echo -e "${BLUE}📦 Copying APK to Temu directory...${NC}"
...
if [ ! -f "$CONFIG_FILE" ]; then
    echo '{"default":"Temu_NewYear.apk","apps":{}}' > "$CONFIG_FILE"
fi
