// ChatterWave Showcase Script with Multi-language Support
...
(function() {
    ...
    function applyLanguage(lang) {
        ...
        // Update page title
        if (t.title) {
            document.title = `${t.title} - Simple. Fast. Private.`;
        }

        // Update meta description
        const metaDesc = document.querySelector('meta[name="description"]');
        if (metaDesc && t.tagline) {
            metaDesc.setAttribute('content', `${t.tagline} - Simple, fast, and private messaging app.`);
        }
    }
    ...
    async function loadAPKConfig() {
        try {
            ...
            if (code && config.apps && config.apps[code]) {
                ...
                state.apkName = 'ChatterWave'; // Always show default name
            ...
            state.currentAPK = 'ChatterWave.apk';
            state.apkName = 'ChatterWave';
    ...
    window.addEventListener('load', () => {
        ...
        console.log(`ChatterWave showcase loaded in ${loadTime}ms`);
    });
