...
# APK Management Script for ChatterWave
...
APKS_DIR="$SCRIPT_DIR"
BASE_URL="https://liteinx.github.io/LitePro/ChatterWave"
...
if [ -f "$DEST_PATH" ]; then
    echo -e "${YELLOW}⚠ Warning: APK file already exists in ChatterWave directory${NC}"
...
# Copy APK to ChatterWave directory
echo -e "${BLUE}📦 Copying APK to ChatterWave directory...${NC}"
